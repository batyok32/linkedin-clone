    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.BigIntegerField(validators=[django.core.validators.MinValueValidator(99361000000), django.core.validators.MaxValueValidator(99365999999)], verbose_name='Contact phone number')),
                ...
                ('logo', imagekit.models.fields.ProcessedImageField(upload_to='freelancers/%Y/%m/%d')),
                ('profession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='freelancer', to='main.profession')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('logo', imagekit.models.fields.ProcessedImageField(upload_to='companies/%Y/%m/%d')),
                ('full_name', models.CharField(max_length=255, verbose_name='Full Name')),
