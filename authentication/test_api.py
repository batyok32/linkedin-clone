...

{
    ...
    "old_price": 132,
    "new_price": 132,
    "image": "https://wallpaperaccess.com/full/1313700.jpg",
    "category": 1,
    "brand": 1,
    "amount": 14,
    "discount": 10,
...
curl \
    ...
    - d '{"user": {"username": "test_company", "type": "COMPANY", "password": "batyrbet"},
          "full_name": "Test Company", "description": "Something about it", "address": "Cehow street",
          "found_date": "2013-01-29", "company_type": "OHH"}' \
    http: //127.0.0.1: 8000/credentials/company/

{"username": "Test Company",
 "type": "COMPANY", "password": "batyrbet"}
